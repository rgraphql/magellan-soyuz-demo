...
$root.demo = (function() {
     ...
     * @property {number} RPC_Ping=1 RPC_Ping value
     * @property {number} RPC_RGQLClientMessage=2 RPC_RGQLClientMessage value
     * @property {number} RPC_RGQLServerMessage=3 RPC_RGQLServerMessage value
     */
    demo.RPC = (function() {
        var valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "RPC_Unknown"] = 0;
        values[valuesById[1] = "RPC_Ping"] = 1;
        values[valuesById[2] = "RPC_RGQLClientMessage"] = 2;
        values[valuesById[3] = "RPC_RGQLServerMessage"] = 3;
        return values;
    })();

    demo.RPCMessage = (function() {

        /**
         * Properties of a RPCMessage.
         * @memberof demo
         * @interface IRPCMessage
         * @property {demo.RPC|null} [rpcId] RPCMessage rpcId
         * @property {rgraphql.IRGQLClientMessage|null} [rgqlClientMessage] RPCMessage rgqlClientMessage
         * @property {rgraphql.IRGQLServerMessage|null} [rgqlServerMessage] RPCMessage rgqlServerMessage
         */
         ...
         * @constructor
         * @param {demo.IRPCMessage=} [properties] Properties to set
         */
        ...
        /**
         * RPCMessage rpcId.
         * @member {demo.RPC} rpcId
         * @memberof demo.RPCMessage
         * @instance
         */
        RPCMessage.prototype.rpcId = 0;

        /**
         * RPCMessage rgqlClientMessage.
         * @member {rgraphql.IRGQLClientMessage|null|undefined} rgqlClientMessage
         * @memberof demo.RPCMessage
         * @instance
         */
        RPCMessage.prototype.rgqlClientMessage = null;

        /**
         * RPCMessage rgqlServerMessage.
         * @member {rgraphql.IRGQLServerMessage|null|undefined} rgqlServerMessage
         * @memberof demo.RPCMessage
         * @instance
         */
        RPCMessage.prototype.rgqlServerMessage = null;
         ...
         * @static
         * @param {demo.IRPCMessage=} [properties] Properties to set
         * @returns {demo.RPCMessage} RPCMessage instance
         */
        ...
        /**
         * Encodes the specified RPCMessage message. Does not implicitly {@link demo.RPCMessage.verify|verify} messages.
         * @function encode
         * @memberof demo.RPCMessage
         * @static
         * @param {demo.IRPCMessage} message RPCMessage message or plain object to encode
        ...
        RPCMessage.encode = function encode(message, writer) {
            ...
            if (message.rpcId != null && Object.hasOwnProperty.call(message, "rpcId"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.rpcId);
            if (message.rgqlClientMessage != null && Object.hasOwnProperty.call(message, "rgqlClientMessage"))
                $root.rgraphql.RGQLClientMessage.encode(message.rgqlClientMessage, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.rgqlServerMessage != null && Object.hasOwnProperty.call(message, "rgqlServerMessage"))
                $root.rgraphql.RGQLServerMessage.encode(message.rgqlServerMessage, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified RPCMessage message, length delimited. Does not implicitly {@link demo.RPCMessage.verify|verify} messages.
         ...
         * @returns {demo.RPCMessage} RPCMessage
        ...
        RPCMessage.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.demo.RPCMessage();
            while (reader.pos < end) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    message.rgqlClientMessage = $root.rgraphql.RGQLClientMessage.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.rgqlServerMessage = $root.rgraphql.RGQLServerMessage.decode(reader, reader.uint32());
                    break;
                default:
        ...
        RPCMessage.verify = function verify(message) {
            ...
            if (message.rpcId != null && message.hasOwnProperty("rpcId"))
                ...
                default:
                    return "rpcId: enum value expected";
                case 0:
                case 1:
                case 2:
                case 3:
            ...
            if (message.rgqlClientMessage != null && message.hasOwnProperty("rgqlClientMessage")) {
                var error = $root.rgraphql.RGQLClientMessage.verify(message.rgqlClientMessage);
                if (error)
                    return "rgqlClientMessage." + error;
            }
            if (message.rgqlServerMessage != null && message.hasOwnProperty("rgqlServerMessage")) {
                var error = $root.rgraphql.RGQLServerMessage.verify(message.rgqlServerMessage);
                if (error)
                    return "rgqlServerMessage." + error;
            }
            return null;
        };
        ...
        RPCMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.demo.RPCMessage)
                return object;
            var message = new $root.demo.RPCMessage();
            switch (object.rpcId) {
            case "RPC_Unknown":
            case 0:
                message.rpcId = 0;
            ...
            if (object.rgqlClientMessage != null) {
                if (typeof object.rgqlClientMessage !== "object")
                    throw TypeError(".demo.RPCMessage.rgqlClientMessage: object expected");
                message.rgqlClientMessage = $root.rgraphql.RGQLClientMessage.fromObject(object.rgqlClientMessage);
            }
            if (object.rgqlServerMessage != null) {
                if (typeof object.rgqlServerMessage !== "object")
                    throw TypeError(".demo.RPCMessage.rgqlServerMessage: object expected");
                message.rgqlServerMessage = $root.rgraphql.RGQLServerMessage.fromObject(object.rgqlServerMessage);
            }
            return message;
        };
         ...
         * @memberof demo.RPCMessage
         * @static
         * @param {demo.RPCMessage} message RPCMessage
        ...
        RPCMessage.toObject = function toObject(message, options) {
            ...
            var object = {};
            if (options.defaults) {
                object.rpcId = options.enums === String ? "RPC_Unknown" : 0;
                object.rgqlClientMessage = null;
                object.rgqlServerMessage = null;
            }
            if (message.rpcId != null && message.hasOwnProperty("rpcId"))
                object.rpcId = options.enums === String ? $root.demo.RPC[message.rpcId] : message.rpcId;
            if (message.rgqlClientMessage != null && message.hasOwnProperty("rgqlClientMessage"))
                object.rgqlClientMessage = $root.rgraphql.RGQLClientMessage.toObject(message.rgqlClientMessage, options);
            if (message.rgqlServerMessage != null && message.hasOwnProperty("rgqlServerMessage"))
                object.rgqlServerMessage = $root.rgraphql.RGQLServerMessage.toObject(message.rgqlServerMessage, options);
            return object;
        };
